...
Vel = $ ? $.Velocity : Velocity,
        ...
        a(document).ready(function () {
            ...
            a(this).each(function () {
                ...
                if (!d.hasClass("browser-default")) {
                    ...
                    d.data("select-id", g);
                    var h = a('<div class="select-wrapper1"></div>');
    ...
    //
    function calculate_subtotal(price_per_each, quantity) {
        var price_per_each
        var quantity
        var subtotal
        subtotal = price_per_each * quantity        
    return subtotal

    }(jQuery),
    function identify_rows_in_table(table) {

        return rows_selectors
    }(jQuery),
    function calculate_total(rows_selectors) {
        identify_rows_in_table(selector)
        calculate_subtotal(price_per_each, quantity)
